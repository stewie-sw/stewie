...
_BACKENDS: tuple[PhysicsBackendAuthority, ...] = (
    ...
    {"id": "gazebo", "authority_scope": ["robot", "sensor", "contact", "clock"], "conserves_mass": False,
     ...
     "description": "Gazebo robot/sensor/contact/odometry/clock simulation; truth-isolated; validates robot behavior, not terrain truth."},
    ...
    {"id": "godot", "authority_scope": ["rendering"], "conserves_mass": False,
     ...
     "description": "High-fidelity rendering/replay; communicates predicted/actual state, owns no physics."},
)
