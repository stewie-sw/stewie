...
|---|------|------|-----------|--------|----------|--------------|
| 1 | Level landing pad → Perimeter blast berm | cutfill | (40,30) | 3.46 | 3.7 d | 3.0 |

## Material balance
- cut **3.5 t** → fill **3.5 t** · surplus(spoil) 0.0 t · deficit(import) 0.0 t · sinter 0.00 t

## Totals
- Project time **3.7 d** (89 h) · moved **3.5 t** (115 drum loads)
- Energy **14.6 MJ** = 3.0 charges (3 recharge stops) · drive 1.56 km · incl. **0.00 MJ** lifting regolith uphill (exact m·g·Δh, real DEM)
...
- **116 drum cycles** (offload events); drum fill SENSED from motor current (no load cell, ICE-RASSOR NTRS 20210022781) -- known to ±2.6% when >half full, ±7.4% below; rover offloads at the upper confidence bound
