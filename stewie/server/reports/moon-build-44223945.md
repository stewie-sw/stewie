# Lunar Build Mission Plan — Moon build

**Body:** Moon · **Date:** 2026-06-03 · cut-fill balanced · sequence **auto** optimizing **time**

## Sequence
| # | Trip | kind | Site (x,y) | Mass t | Duration | Energy (chg) |
|---|------|------|-----------|--------|----------|--------------|
| 1 | Borrow pit (berm) → Blast berm | cutfill | (-12,0) | 29.25 | 32.2 d | 26.1 |

## Material balance
- cut **29.2 t** → fill **29.2 t** · surplus(spoil) 0.0 t · deficit(import) 0.0 t · sinter 0.00 t

## Totals
- Project time **32.2 d** (774 h) · moved **29.2 t** (975 drum loads)
- Energy **125.5 MJ** = 26.2 charges (29 recharge stops) · drive 29.97 km · incl. **0.00 MJ** lifting regolith uphill (exact m·g·Δh, real DEM)
...
- **975 drum cycles** (offload events); drum fill SENSED from motor current (no load cell, ICE-RASSOR NTRS 20210022781) -- known to ±2.6% when >half full, ±7.4% below; rover offloads at the upper confidence bound
