# Lunar Build Mission Plan — test mission
...
|---|------|------|-----------|--------|----------|--------------|
| 1 | excavate → dump | cutfill | (5,5) | 2.60 | 2.8 d | 2.3 |
| 2 | Excavate spoil: excavate | dig | (5,5) | 3.16 | 3.4 d | 2.7 |

## Material balance
- cut **5.8 t** → fill **2.6 t** · surplus(spoil) 3.2 t · deficit(import) 0.0 t · sinter 0.00 t

## Totals
- Project time **6.1 d** (147 h) · moved **5.8 t** (192 drum loads)
- Energy **24.0 MJ** = 5.0 charges (5 recharge stops) · drive 0.95 km · incl. **0.00 MJ** lifting regolith uphill (exact m·g·Δh, real DEM)
...
- **87 drum cycles** (offload events); drum fill SENSED from motor current (no load cell, ICE-RASSOR NTRS 20210022781) -- known to ±2.6% when >half full, ±7.4% below; rover offloads at the upper confidence bound
