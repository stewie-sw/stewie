# Lunar Build Mission Plan — mv-probe
...
|---|------|------|-----------|--------|----------|--------------|
| 1 | Excavate spoil: cut-a | dig | (10,0) | 0.19 | 4.6 h | 0.2 |
| 2 | Excavate spoil: cut-b | dig | (-10,0) | 0.19 | 4.6 h | 0.2 |

## Material balance
- cut **0.4 t** → fill **0.0 t** · surplus(spoil) 0.4 t · deficit(import) 0.0 t · sinter 0.00 t

## Totals
- Project time **4.6 h** (5 h) · moved **0.4 t** (13 drum loads)
- Energy **1.6 MJ** = 0.3 charges (0 recharge stops) · drive 0.04 km
