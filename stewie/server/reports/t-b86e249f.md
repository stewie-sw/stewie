...
## Totals
- Project time **4.2 d** (100 h) · moved **3.5 t** (115 drum loads)
...
- **56 drum cycles** (offload events); drum fill SENSED from motor current (no load cell, ICE-RASSOR NTRS 20210022781) -- known to ±2.6% when >half full, ±7.4% below; rover offloads at the upper confidence bound
- Hauls **routed around hazards** on the real Haworth slope costmap (traverse cap 25°): **+0.0% detour** over straight lines
- **Per-sortie range:** 32.1 km flat to reserve (35.6 km full pack, 30 h driving at 0.30 m/s); **27.5 km** slope+slip-adjusted at the work-area median 17° slope
