...
|---|------|------|-----------|--------|----------|--------------|
| 1 | Excavate spoil: cut job | dig | (5,5) | 0.86 | 20.6 h | 0.7 |

## Material balance
- cut **0.9 t** → fill **0.0 t** · surplus(spoil) 0.9 t · deficit(import) 0.0 t · sinter 0.00 t

## Totals
- Project time **20.6 h** (21 h) · moved **0.9 t** (29 drum loads)
- Energy **3.6 MJ** = 0.7 charges (0 recharge stops) · drive 0.01 km
