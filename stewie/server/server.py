...
async def lifespan(_app: "FastAPI"):
    ...
    _auth.require_session_secret_for_prod()               # BP-03: prod needs a standalone session secret (raises)
...
from stewie.server.routers import fleet as _fleet_router  # noqa: E402
