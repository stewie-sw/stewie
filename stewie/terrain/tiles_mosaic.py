...
from stewie.terrain import dem_io, dem_overlay

from stewie.physics import refinement
from stewie.physics.refinement import Tile
...
def _selftest() -> int:
    ...
    import numpy as _np
    from stewie.terrain import procgen_seed as _ps
    from stewie.physics.quadtree import quadtree_pad_pow2 as _pad
