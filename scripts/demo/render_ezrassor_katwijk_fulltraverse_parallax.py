...
STAGE = "/tmp/claude-1000/-mnt-projects/56ff42d5-5b12-4ac9-b424-8c422e825760/scratchpad/ezrassor_ft_stage"
SCENES_ROOT = f"{ROOT}/out/scenes"
ARTIFACT_DIR = f"{ROOT}/stewie/eval/validation"
ARTIFACT = f"{ARTIFACT_DIR}/ezrassor_katwijk_fulltraverse_articulation_parallax_2026-07-02.json"
README = f"{ARTIFACT_DIR}/ezrassor_katwijk_fulltraverse_articulation_parallax_2026-07-02.README.md"

SUN_ELEV, SUN_AZIM, SIZE = "5", "215", "1024x768"
EXTENT_M = 50.0          # tile side (<< 100 m far-plane; rover-to-farthest-corner <= ~52 m)
...
for t in tiles:
    t["scene_name"] = f"katwijk_part4_ft_tile{t['k']}"
...
readme = f"""# EZ-RASSOR on real Katwijk -- FULL-TRAVERSE articulation-parallax absolute-fix (2026-07-02)
