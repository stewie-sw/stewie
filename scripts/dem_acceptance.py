...
from stewie.terrain import dem_stats  # noqa: E402
from stewie.terrain import procgen_csfd  # noqa: E402
from stewie.twin.io_fields import load_scene  # noqa: E402
from stewie.physics.refinement import coarsen_field, refine_field  # noqa: E402
...
def run_report(scene_dir: str = DEFAULT_SCENE, slp_path: str = DEFAULT_SLP) -> int:
    ...
    synth_field = None
    try:
        from stewie.terrain.scenes import build_from_dem  # type: ignore
        try:
