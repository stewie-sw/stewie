...
module.exports = (env, argv) => {
    ...
    return {
        ...
        output: {
            ...
            // Coexisting subpath deploy at artemis.stewie.space/ide/ : the injected app
            // bundle + all lazy-loaded plugin chunks resolve under /ide/ (webpack runtime
            // __webpack_require__.p). The live OL viewer stays at / untouched.
            publicPath: '/ide/',
