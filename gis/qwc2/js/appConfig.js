...
import MissionDrive3DPlugin from './plugins/MissionDrive3D';   // STEWIE: viz2 drive-validate embed (GIS fold — the authored mission drives the rover)
...
import MissionUserLayerPlugin from './plugins/MissionUserLayer';   // STEWIE: [REQ:LY-01] user-layers subsystem (CRS-validated import)
...
export default {
    ...
    pluginsDef: {
        plugins: {
            ...
            MissionDrive3DPlugin: MissionDrive3DPlugin,   // STEWIE: viz2 drive-validate embed
            ...
            MissionUserLayerPlugin: MissionUserLayerPlugin,   // STEWIE: [REQ:LY-01] user-layers subsystem
        },
        cfg: {
            IdentifyPlugin: {
