...
# CHARGE_W / LOCALIZATION_MARGIN_M / _CONSTRAINT_CAPS / ROVER_MASS_KG / SLIP_ALPHA / _TM_PARAMS now live
# in lode.planner_constants (ARCH-2 #123), imported above; RESERVE_FRAC likewise (ARCH-03). Values + the
# uses below are byte-identical.
