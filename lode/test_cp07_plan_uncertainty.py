...
def test_honest_quantified_flags():
    ...
    # modeled elsewhere but NOT propagated to a plan band -> honestly flagged unquantified (no fabricated band)
    assert pu["drum_fill"]["quantified"] is False and pu["slip"]["quantified"] is False
