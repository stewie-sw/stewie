...
from solnav.perception import mapping, stereo_vo

HERE = os.path.dirname(__file__)
CAM = os.path.join(HERE, "..", "validation", "a6_traverse", "cam")
SEQUENCE = os.path.join(HERE, "..", "validation", "a6_traverse", "sequence.json")
# EVAL-ONLY truth (GROUND_TRUTH_EVAL poses); read only in the scoring/anchoring path below.
TRUTH = os.path.join(HERE, "..", "validation", "a6_traverse", "truth", "truth.json")
