...
**Loop pick order (P1 first):** HF-01 · ML-10 · SV-01 → SC-01 → OF-01 → PX-07 · CG-01 → RO-01 → SC-02 · TS-01 · PD-01 · TT-01 → QB-01 · CR-01 · TF-01 (the learned-ML + onboard rows correctly trail the deterministic core).
