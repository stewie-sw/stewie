...
| GW-10 | P1 | A per-component monotonic request guard drops a stale in-flight response so a slow site-A load resolving after a switch to site-B cannot overwrite B's raster/physics/inspector state. (hardens GW-02) [SHIPPED: gis/qwc2/js/mission/reqGuard.js + reqGuard.test.js] | N | N | N | NA |
