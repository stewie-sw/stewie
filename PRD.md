...
| QG-02 | P1 | QGIS-Server publishes the shared-core .qgz as OGC WMS/WMTS/WFS (one project, two clients): a --profile gis GetMap on a site in IAU_2015:30135 returns a pole-truthful tile matching QGIS Desktop. [SHIPPED: gis/stewie_south_pole.qgz + deploy/compose.yml:251 P1.8] | N | N | N | NA |
