...
| EV-01 | P1 | **Evidence/Report reproduces.** A report reproduces plan inputs + selected layers + assumptions + runtime profile + ROS/Gazebo/RViz/Godot artifacts + world transactions + audit trail; a single evidence bundle proves what ran. (extends RF-03/MT-05) | D | D | P | NA |
