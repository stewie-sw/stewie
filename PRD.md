...
| GW-05 | P0 | **GIS map substrate.** MapLibre/GeoLibre in the LOCAL south-polar-stereographic frame renders NASA Trek raster tiles + local LOLA terrain-RGB (`heightmap.rf32`, full 5 m native — not a downscaled preview); control points round-trip `/dem/site_xy` + `/dem/site_lonlat` within tolerance; no WGS84/Earth claim on lunar coordinates. (extends GL-01; needs GW-00) | N | N | N | NA |
...
| TT-01 | P2 | **TiTiler raster serving.** A TiTiler dynamic-COG tiler serves site DEM/imagery raster tiles on demand as an alternative to QGIS-Server WMS; a tile request returns a correct lunar-frame tile within tolerance; adopt-vs-keep-WMS is a recorded decision. (extends GW-05/FR-12) | N | N | N | NA |
