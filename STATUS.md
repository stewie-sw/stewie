...
- cited by >=1 test ([REQ:] marker): **146**
- V!=D flagged (FS-22 audit: cited but not yet V=D): **41**
...
- in matrix: 16/16
- cited: 16/16
- currently V=D: ['AS-02', 'AS-03', 'AS-05', 'AS-06', 'AS-17']
- eligible for V=D: ['AS-02', 'AS-03', 'AS-05', 'AS-06', 'AS-17']
